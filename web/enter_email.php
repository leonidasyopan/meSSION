...
<head>
    ...
    <title>Reset email | meSSION</title>  
        ...
        <div class="container" id="container">
            ...
            <div class="form-container sign-in-container">
                <form action="enter_email.php" method="POST" id="send-reset-email-form">
                    ...
                    <span>Email used when you registered your account.</span>

                    <?php include $_SERVER['DOCUMENT_ROOT'] . '/errors/errors_email.php'; ?>

                    <fieldset>
                        <input type="email" name="email" id="email" placeholder="Email">
                        <button type="submit" class="btn" name="reset-password">Send email</button>
                    </fieldset>
                </form>
            </div>
